...
#define STRING_CONFIG_H_AUTHOR "(Baus, Predator)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RUMBA32_V1_1
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "Rumba32 PREDATOR Ready"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 60.64
  #define DEFAULT_bedKi 11.32
  #define DEFAULT_bedKd 216.5
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 439.809 // (mm)
  // Delta diagonal rod  adjustment (mm)
  #define DELTA_DIAGONAL_ROD_TRIM_TOWER { -0.251, 0.462, -0.211, }



  #define DELTA_ENDSTOP_ADJ { -2.033, -1.391, 0 } // Get these values from G33 auto calibrate
  
  
  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 430.43// (mm) Get this value from G33 auto calibrate
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.022, 0.269, 0.29 } // Get these values from G33 auto calibrate


  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 226.21              // (mm) Get this value from G33 auto calibrate
 // Delta radius adjustment (mm)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 120, 125 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 2000, 40000 }
